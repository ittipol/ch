    ...
    <div class="row">
      <div class="col-md-6 col-sm-12">
        <dl class="row">
          ...
          <dd class="col-sm-9">{{$_modelData['_realEstateTypeName']}}</dd>
        </dl>

        <dl class="row">
          <dt class="col-sm-3">พื้นที่ใช้สอย</dt>
          <dd class="col-sm-9">{{$_modelData['_homeArea']}}</dd>
        </dl>

        <dl class="row">
          <dt class="col-sm-3">พื้นที่ที่ดิน</dt>
          <dd class="col-sm-9">{{$_modelData['_landArea']}}</dd>
        </dl>
      </div>
      ...
      <div class="col-md-6 col-sm-12">
        <dl class="row">
          ...
          <dd class="col-sm-9">{{$_modelData['_furniture']}}</dd>
        </dl>
      </div>
    </div>
