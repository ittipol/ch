  ...
  <div class="container">
    ...
    <div class="container-header">
      <div class="row">
        <div class="col-lg-6 col-sm-12">
          <div class="title">
            เพิ่มธุรกิจ หรือ ร้านค้าออนไลน์ของคุณ
          </div>
    ...
    <div class="row">
      <div class="col-lg-4 col-sm-12">
        <div class="box">
          <div class="inner">
            <h4>บริษัท องค์กร ร้านค้า หรือ ธุรกิจ</h4>
            ...
            <a href="{{URL::to('entity/add?type=business')}}" class="button">เพิ่มบริษัท องค์กร หรือ ธุรกิจ</a>
          </div>
        </div>
      </div>
